        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title-desc">City Edit</h4>

                            <form action="{{ route('admin.city.edit', $city->id) }}" method="post">
                                @csrf
                                            ...
                                            <div class="tab-pane @if(++$key ==1) active @endif" id="{{$lang['code']}}" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        ...
                                                        <input class="form-control" type="text" name="name[{{$lang['code']}}]" value="{{ json_decode($city, true)['name']['az'] }}"
                                                               id="input-{{$lang['code']}}" />
                                                        @if ($errors->any())
