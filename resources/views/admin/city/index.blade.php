                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="body d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="{{ route('admin.city.create') }}" class="ml-auto btn btn-success">Add</a>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($cities as $data)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-link p-0" href="{{ route('admin.city.edit', $data['id']) }}" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Edit"><span
                                                        class="text-500 fas fa-edit"></span></a>
                                                <form action="{{ route('admin.city.destroy',$data['id']) }}" method="post" style="display:inline-block">
                                                    @csrf
                                                    @method('DELETE')
