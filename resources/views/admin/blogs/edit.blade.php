                                                ...
                                                <div class="row">
                                                    <div class="mb-3 row">
                                                        <div class="col-md-10">
                                                            ...
                                                            <input class="form-control" type="text" name="title[{{$lang['code']}}]" value="{{ json_decode($blog, true)['title'][$lang['code']] }}"  />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        <div class="col-md-10">
                                                            ...
                                                            <textarea class="summernote-height form-control" type="text" name="description[{{$lang['code']}}]" >{{ json_decode($blog, true)['description'][$lang['code']] }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="other" role="tabpanel">
                                        <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <select class="form-control" name="category_id" id="input-category">
                                                        ...
                                                        @foreach($categories as $category)
                                                            <option value="{{$category->id}}" @if($blog->category_id == $category->id) selected @endif>{{ json_decode($category, true)['name']['az'] }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-5">
                                                    ...
                                                    <select class="form-control" name="sub_category_id">
                                                        @if(!empty($blog->subcategory->id))
                                                            <option value="{{$blog->subcategory->id}}" >{{ json_decode($blog->subcategory, true)['name']['az'] }}</option>
                                                        @else
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-5">
                                                    <img src="{{ asset('uploads/blogs/'.$blog->image) }}" style="width: 288px;!important;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
