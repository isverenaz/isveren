        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title-desc">Page Create</h4>
                                ...
                                <div class="tab-content p-3 text-muted">
                                                ...
                                                <div class="row">
                                                    <div class="mb-3 row">
                                                        <div class="col-md-10">
                                                            ...
                                                            <input class="form-control" type="text" name="title[{{$lang['code']}}]" value="" id="input-{{$lang['code']}}" />
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <div class="col-md-10">
                                    ...
                                    <div class="tab-pane" id="other" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-md-10">
                                                    <label for="input-contract" class="form-label">Page</label>
