        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title-desc">Kategorya Edit</h4>
                                    ...
                                    @if(!empty($locales))
                                        ...
                                        <div class="row">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ !empty(json_decode($category, true)['name'][$lang['code']])? json_decode($category, true)['name'][$lang['code']]: '' }}" name="name[{{$lang['code']}}]" id="input-az">
                                            @if ($errors->any())
