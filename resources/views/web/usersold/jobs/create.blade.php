                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('web.user.jobs.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-14">
                                        <textarea class="summernote-height form-control" name="description[az]" rows="3" placeholder="@lang('web.description')"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-14">
                                        <div class="input-daterange input-group">
                                            <input type="number" class="form-control" placeholder="@lang('web.min_salary')"
                                                name="min_salary" />
                                            <input type="number" class="form-control"  style="margin-left: 5px" placeholder="@lang('web.max_salary')"
                                                name="max_salary" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-14">
                                        <div class="input-daterange input-group">
                                            ...
                                            <select class="form-control" name="sub_category_id" style="margin-left: 5px">
                                        ...
                                        <div class="input-daterange input-group">
                                            <select class="form-control select2" name="city_id" id="input-city">
                                                ...
                                                @endforeach
                                                    ...
                                                    <select class="form-control select2" name="job_type_id" id="input-type"  style="margin-left: 5px">
                                            ...
                                            <select class="form-control select2" name="company_id" id="input-company">
                                                ...
                                                @foreach ($companies as $company)
                                                    <option value="{{ $company->id }}">
                                                        {{ json_decode($company, true)['name']['az'] }}</option>
                                                @endforeach
                                            </select>
