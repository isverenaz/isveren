                ...
                <div class="wt-bnr-inr-entry">
                    <div class="banner-title-outer">
                        <div class="banner-title-name">
                            <h2 class="wt-title">İstədiyin fürsətlər bir klik uzağında!</h2>
                        </div>
                    </div>
                    <!-- BREADCRUMB ROW -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 rightSidebar">
                        ...
                        <a href="https://wa.me/+994997027093" target="_blank">
                            <img src="https://isveren.az/reklams/d.png" alt="İş verən" class="w-100" style="animation: fadeIn 5s ease-in-out;!important;">
                        </a>
                        </div>
...
@section('web.js')
    ...
    @include('components.web.js',['page' => 'companies'])
@endsection
