...
@section('web.css')
    ...
    <style>
        ...
        .ad-left {
            left: 10px; /* sola yaxınlaşdır */
        }

        .ad-right {
            right: 10px; /* sağa yaxınlaşdır */
        }
...
@section('web.section')
    ...
    <div class="page-content">
        ...
        <div class="section-full p-t120  p-b90 site-bg-white">
           {{-- <div class="ad-banner ad-left side-desktop">
                <a href="https://wa.me/+994997027093" target="_blank">
                <img src="https://isveren.az/reklams/d.png" alt="isveren.az">
                </a>
            </div>

            <div class="ad-banner ad-right side-desktop">
                <a href="https://wa.me/+994997027093" target="_blank">
                <img src="https://isveren.az/reklams/d.png" alt="isveren.az">
                </a>
            </div>--}}
...
@section('web.js')
    ...
    @include('components.web.js',['page' => 'home'])
@endsection
