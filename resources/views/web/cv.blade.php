...
@section('web.css')
    ...
    <meta name="og:image" content="/web/assets/img/favicon.png">
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="isveren.az - CV Yaratma və Yerləşdirmə | Azərbaycanda İşəgötürənlər üçün Ən Yaxşı Platforma" />
    <meta name="twitter:description" content="isveren.az saytında CV yaradın və işəgötürənlərə çatdırın. Azərbaycanda ən son vakansiyalar üçün CV yerləşdirin və yeni iş imkanlarını kəşf edin." />
    <meta name="twitter:image" content="https://isveren.az/web/assets/img/favicon.png" />
    <style>
                ...
                <div class="wt-bnr-inr-entry">
                    <div class="banner-title-outer">
                        <div class="banner-title-name">
                            <h2 class="wt-title">Komandanız üçün ən uyğun namizədlər burada!</h2>
                        </div>
                    </div>
                    <!-- BREADCRUMB ROW -->
                                        ...
                                        <div class="modal-body">
                                            <div class="sidebar-elements search-bx">
                                                <form id="filterFormMobile">
                                                    <div class="form-group mb-4">
                                                        <h4 class="section-head-small mb-4">@lang('site.main_categories')</h4>
                                                        <select class="wt-select-bar-large selectpicker" id="main_category_mobile" name="main_category" data-live-search="true" data-bv-field="size">
...
@section('web.js')
    ...
    @include('components.web.js',['page' => 'cv'])
@endsection
