...
@section('user.section')
    <div class="col-xl-9 col-lg-8 col-md-12 m-b30">
        ...
        <div class="twm-right-section-panel site-bg-gray">
            <form id="companySave" action="{{ route('web.user.company.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!--Job title-->
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" name="name[az]" type="text" placeholder="İş Verən Consulting" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <div class="ls-inputicon-box">
                                    <input class="form-control" name="address[az]" type="text" placeholder="Azərbaycan/Bakı" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" name="description[az]" placeholder="..." required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')"></textarea>
                        </div>
                    </div>
