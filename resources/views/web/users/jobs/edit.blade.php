...
@section('user.section')
    <div class="col-xl-9 col-lg-8 col-md-12 m-b30">
        ...
        <div class="twm-right-section-panel site-bg-gray">
            <form id="jobSave" action="{{ route('web.user.jobs.update',$job->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <!--Job title-->
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" name="title[az]" type="text" value="{{$job['title']['az']}}" placeholder="Proqramçı, Menecer və s." required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group city-outer-bx has-feedback">
                            ...
                            <div class="ls-inputicon-box">
                                <select class="wt-select-box selectpicker"  data-live-search="true" title="" id="j-category" data-bv-field="size" name="category_id" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                                    <option value="">Əsas kateqorya seç</option>
                                    @if(!empty($categories[0]))
                                        @foreach($categories as $category)
                                            <option value="{{$category['id']}}"  @if($category['id'] == $job['jobcategory']['category_id']) selected @endif>{{$category['name']['az']}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                ...
                                <select class="wt-select-box selectpicker"  data-live-search="true" title="" id="s-job-type" data-bv-field="size" name="job_type_id" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                                    ...
                                    @if(!empty($types[0]))
                                        @foreach($types as $type)
                                            <option value="{{$type['id']}}" @if($type['id'] == $job['job_type_id']) selected @endif>{{$type['name']['az']}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                ...
                                <select class="wt-select-box selectpicker"  data-live-search="true" title="" id="s-city" name="city_id" data-bv-field="size" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                                    ...
                                    @if(!empty($cities[0]))
                                        @foreach($cities as $city)
                                            <option value="{{$city['id']}}" @if($city['id'] == $job['city_id']) selected @endif>{{$city['name']['az']}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                ...
                                <select class="wt-select-box selectpicker"  data-live-search="true" title="" id="company" name="company_id" data-bv-field="size" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                                    ...
                                    @if(!empty($companies[0]))
                                        @foreach($companies as $company)
                                            <option value="{{$company['id']}}" @if($company['id'] == $job['company_id']) selected @endif>{{$company['name']['az']}}</option>
                                        @endforeach
                                    @endif
                                </select>
                                <i class="fs-input-icon fa fa-globe-americas"></i>
                    ...
                    <?php [$min_salary, $max_salary] = explode('-', $job['price']); ?>
{{--                    @dd($max_salary)--}}
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" name="min_salary" value="{{ (int)$min_salary }}"  type="number" placeholder="300" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" name="max_salary" value="{{ (int)$max_salary }}" type="number" placeholder="800">
                                <i class="fs-input-icon fa fa-dollar-sign"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            <label>E-poçt</label>
                            <div class="ls-inputicon-box">
                                <input class="form-control" name="email" type="email" value="{{$job['email']}}" placeholder="isveren.consulting@gmail.com" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control" name="phone" type="text" value="{{$job['phone']}}" placeholder="+99499 702 70 93" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control datepicker" data-provide="datepicker" name="start_date" type="text" value="{{ DateTime::createFromFormat('Y-m-d', $job->start_date)->format('d/m/Y') }}" placeholder="mm/dd/yyyy" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="ls-inputicon-box">
                                <input class="form-control datepicker" data-provide="datepicker" name="end_date" value="{{ DateTime::createFromFormat('Y-m-d', $job->end_date)->format('d/m/Y') }}" type="text" placeholder="mm/dd/yyyy" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">
                                <i class="fs-input-icon far fa-calendar"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <div>
                                <input name="is_premium"  id="is_premium" @if($job['is_premium'] == 1) checked @endif class="vacancy-option" type="checkbox" value="1">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="form-group">
                            ...
                            <div>
                                <input name="is_new"  id="is_new" @if($job['is_new'] == 1) checked @endif class="vacancy-option" type="checkbox" value="1">
                                <i class="fs-input-icon far fa-check"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="summernote-height form-control" rows="3" name="description[az]" required="required" oninvalid="this.setCustomValidity('Zəhmət olmasa, bu sahəni doldurun.')" oninput="this.setCustomValidity('')">{!! $job['description']['az'] !!}</textarea>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $('#jobSave').submit(function (e) {
                e.preventDefault();
                let formData = new FormData($('#jobSave')[0]);
